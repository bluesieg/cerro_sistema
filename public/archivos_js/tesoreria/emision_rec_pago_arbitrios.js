...
function grid_predios_arbitrios(){
    jQuery("#table_Predios_Arbitrios").jqGrid({
        ...
        colNames: ['id_pred', 'id_contrib','Cod.Cat','Direccion','Contribuyente / Razon Social', 'Tip.Predio', 'Est.Construccion', 'S/. Terreno', 'S/. Contruccion'],
        ...
        colModel: [
            ...
            {name: 'sec', index: 'sec', width: 40},
            {name: 'dir', index: 'dir', width: 150},
            {name: 'contribuyente', index: 'contribuyente', hidden: true},
            {name: 'tp', index: 'tp', width: 40},
