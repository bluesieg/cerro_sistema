...
<main>
    ...
    <center><div Class="asunto" style="margin-top: 10px;"><b>REPORTE GENERAL DE CAJAS</b></div></center>
        ...
        <table border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 0px; font-size: 1.3em;">
            ...
            @foreach ($sql as $caj)
                <tr>
                    ...
                    <td style="text-align: center;">{{$caj->fecha}}</td>
                    <td style="text-align: right; padding-right: 3px;">{{ number_format($caj->sum,2,".",",") }}</td>
                </tr>
            @endforeach
            </tbody>
            <br>
            @foreach ($sql1 as $caj1)
            
            <div class="sub2" style="font-size:0.8em; text-align: right; margin-top: 10;"><b>TOTAL:&nbsp;&nbsp;&nbsp; </b>{{ number_format($caj1->sum,2,".",",") }}</div>
            @endforeach
        </table>
    </div>
</body>
