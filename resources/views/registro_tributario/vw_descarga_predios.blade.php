                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-3">
                                    <div class="input-group input-group-md" style="width: 100%">
                                        ...
                                        <div>
                                            <input id="dlg_fec_hasta" onchange="selecciona_fecha();" name="dlg_fec_hasta" type="text"   class="datepicker text-center" data-dateformat='dd/mm/yy' data-mask="99/99/9999" style="height: 30px; width: 110%" placeholder="--/--/----" value="{{date('28/m/Y')}}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="text-right">
                                        @if( $permisos[0]->btn_new ==1 )
                                            <button type="button" class="btn btn-labeled bg-color-greenLight txt-color-white" onclick="nuevo_dpredios();">
                                                <span class="btn-label"><i class="glyphicon glyphicon-plus-sign"></i></span>NUEVA DESCARGA
                                            </button>
                                        @else
