...
<main>
    ...
    <center><div Class="asunto" style="margin-top: 1px;font-size:0.8em;"><b>REPORTE DE CONTRIBUYENTES FISCALIZADOS {{ $anio }}</b></div></center>
    ...
    <div class="lado3" style=" margin-top: 5px;">
        <table border="0" cellspacing="0" cellpadding="0" style="margin-bottom:20px; margin-top: 0px;  font-size: 1.0em;">
            ...
            <tr >
                ...
                <th style="width: 47%;">PREDIO FISCALIZADO</th>
            </tr>
            </thead>
            <tbody>
            ...
            @foreach ($sql as $cont)
                <tr>
                    <td style="text-align: center;">{{ trim($cont->nro_fic) }}</td>
                    <td style="text-align: center;">{{trim($cont->nro_doc)}}</td>
