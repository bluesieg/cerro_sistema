...
<html lang="en">
    ...
    <body style="font-family: sans-serif;">
      ...
      <img src="img/FONDORE.jpg" style="width: 100%;position: absolute;">      
      <div style="position: absolute;">
      <div style="position: absolute;margin-top: 58px;margin-left: 590px; font-size: 14px;">
            N°.{{$recibo[0]->serie}}
        </div>
        <div style="position: absolute;margin-top: 85px;margin-left: 80px; font-size: 11px;">
           Nombre&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: &nbsp; {{$recibo[0]->contribuyente}}
        </div>
        <div style="position: absolute;margin-top: 100px;margin-left: 80px; font-size: 11px;">
           Dirección&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: &nbsp; {{$recibo[0]->dom_fis}} - {{$recibo[0]->direccion}}
        </div>
        <div style="position: absolute;margin-top: 115px;margin-left: 80px; font-size: 11px;">
           Cajero(a)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: &nbsp; {{$recibo[0]->usuario}}
        </div>
        <div style="position: absolute;margin-top: 130px;margin-left: 80px; font-size: 11px;">
          Recibo N.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: &nbsp; {{$recibo[0]->recib_sistema}}
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[ {{date('M d',strtotime($recibo[0]->fecha))}} ]
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ref:{{$recibo[0]->id_rec_mtr}} 
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{$recibo[0]->serie}}
        </div>
        <div style="position: absolute;margin-top: 145px;margin-left: 80px; font-size: 11px;">
          Emitido&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: &nbsp;  {{$fecha_larga}}
        </div>
        <div style="position: absolute;margin-top: 160px;margin-left: 80px; font-size: 11px;">
      ...
      <div style="position: absolute;margin-top: 378px">
           <div style="position: absolute;margin-top: 58px;margin-left: 590px; font-size: 14px;">
            N°.{{$recibo[0]->serie}}
        </div>
        <div style="position: absolute;margin-top: 85px;margin-left: 80px; font-size: 11px;">
      ...
      <div style="position: absolute;margin-top: 751px">
           <div style="position: absolute;margin-top: 58px;margin-left: 590px; font-size: 14px;">
            N°.{{$recibo[0]->serie}}
        </div>
        <div style="position: absolute;margin-top: 85px;margin-left: 80px; font-size: 11px;">
